...
output "sql_injection_rule_id_01" {
  ...
  value       = module.owasp_top_10_rules["sql_injection_rule_id_01"]
}
...
output "auth_token_rule_id_02" {
  ...
  value       = module.owasp_top_10_rules["auth_token_rule_id_02"]
}
...
output "xss_rule_id_03" {
  ...
  value       = module.owasp_top_10_rules["xss_rule_id_03"]
}
...
output "paths_rule_id_04" {
  ...
  value       = module.owasp_top_10_rules["paths_rule_id_04"]
}
